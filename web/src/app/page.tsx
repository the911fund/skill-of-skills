          ...
          <div className="bg-white dark:bg-slate-800 p-4 rounded-lg border border-blue-200 dark:border-blue-700">
            ...
            <div className="space-y-2 text-xs">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-600 dark:text-gray-400">Anthropic verified</span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-600 dark:text-gray-400">Meets Golden Ratio</span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-600 dark:text-gray-400">AI validated</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-4 text-sm">
          <div className="space-y-3">
            <div className="flex items-start gap-2">
              ...
              <p className="text-gray-600 dark:text-gray-400">Published by <strong className="text-gray-900 dark:text-gray-100">Anthropic</strong> or an official partner. Highest trust level.</p>
            </div>
            <div className="flex items-start gap-2">
              ...
              <p className="text-gray-600 dark:text-gray-400">Passed <strong className="text-gray-900 dark:text-gray-100">automated validation</strong>: sandbox execution, security scan, and dependency audit.</p>
            </div>
          </div>
          <div className="space-y-3">
            <div className="flex items-start gap-2">
              ...
              <p className="text-gray-600 dark:text-gray-400">Standard permissions only. Safe for general use.</p>
            </div>
            <div className="flex items-start gap-2">
              ...
              <p className="text-gray-600 dark:text-gray-400">Extended permissions (shell access, subagents). Review before use.</p>
            </div>
            <div className="flex items-start gap-2">
              ...
              <p className="text-gray-600 dark:text-gray-400">Broad system access. Carefully review before installing.</p>
            </div>
            <div className="flex items-start gap-2">
              ...
              <p className="text-gray-600 dark:text-gray-400">Manual security review required. Use with extreme caution.</p>
            </div>
          </div>
        </div>
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
          ⚠️ <strong className="text-gray-700 dark:text-gray-300">Unverified tools</strong> have not been reviewed. Always inspect source code from unknown authors before installation.
        </p>
      </section>
